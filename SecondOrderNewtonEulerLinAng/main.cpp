/*
Title: Second Order Newton - Euler Integration (Linear + Angular)
File Name: main.cpp
Copyright © 2015
...
second order Newton - Euler integration to solve for it's angular velocity & orientation,
...
///
//Integrates the angular kinematics of the triangle using second order Newton - Euler integration
//
//Parameters:
//	dt: The time since last physics update
...
void update(float dt)
{
	...
	//
	//Without the cool words, it basically means that linear kinematics and angular kinematics are mostly unrelated to each other.
...
void main()
{
	...
	// Create a window
	window = glfwCreateWindow(800, 800, "Second Order Newton - Euler Integration (Linear + Angular)", nullptr, nullptr);
	...
	triangleBody = new struct RigidBody(
		...
		glm::vec3(0.0f, 0.0f, 1.0f)	//Slowly angularly accelerating CCW around Z axis
		);
